...
public class BoxLayout extends BoxLayoutParent{
	...
	public boolean canFit(Individual indi, double width, double height, PortraitChartOptions ops, double fontSize, String dupLabel ){
	...
	public void drawNormalLines(OpgSession session, ChartMargins chart, PresetChartOptions options, StylingBox style,
			...
			String dupLabel, boolean maleDescendant, Rectangle2D.Double boxCoords, String chartIndex){
