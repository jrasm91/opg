...
public class DescTree {
	...
	public void calcCoords(LandscapeChartOptions ops)
	{
		maxSpouseLineOffset = new int[ops.getDescGens()+1];
		descBox.calcCoords(ops, 0, maxSpouseLineOffset);
	}
	
	public void DrawTree(ChartMargins chart, LandscapeChartOptions options, double x, double y, OpgSession session)
	{
